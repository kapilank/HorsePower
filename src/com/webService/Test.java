	  ...
	  private static String readAll(Reader rd) throws IOException {
		  ...
		  public static JSONObject readJsonFromUrl(String url) throws IOException, JSONException {
			...
			public static void main(String args[]) throws IOException, JSONException, SQLException
		    {
		    	...
		    	JSONObject json = readJsonFromUrl("https://api.edmunds.com/api/vehicle/v2/chevrolet/models?fmt=json&api_key=rvzphv5vyubm9n4f9tgb4dak");
		    	          ...
		    	          // System.out.println("*****************************");
		    	           ...
		    	           // System.out.println("Year name: "+jsonObjyears.get("year"));
		    	            ...
		    	            for(int k=0; k<arrayforstyle.length(); k++){
		    	            	...
		    	            	//System.out.println("**************************");
		    	            	//System.out.println("Style ID"+jsonObjstyle.getInt("));
		    	            	//System.out.println("Styles: "+jsonObjstyle.get("name"));
		    	            	//System.out.println("Name:" +jsonObj.getString("name"));
		    	         //  System.out.println(jsonObjstyle.getInt("id"));
		    	            	String sql="insert into sys.chevy(car_id, car_name, style_id, car_style, production_year) values (?,?,?,?,?) ";
...
/*		    	            	preparedStatement.setString(1, jsonObj.getString("id"));
		    	            	...
		    	            	preparedStatement.setInt(3, jsonObjstyle.getInt("id"));
		    	            	preparedStatement.setString(4, jsonObjstyle.getString("name"));
		    	            	preparedStatement.setInt(5, jsonObjyears.getInt("year"));
